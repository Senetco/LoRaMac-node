...
// Shorten Retransmission duty cycle for testing
#define JOIN_RETRANSMISSION_DCYCLE1   { 60, 10000 }
#define JOIN_RETRANSMISSION_DCYCLE2   { 120,10000} 
#define JOIN_RETRANSMISSION_DCYCLE3   { 180,10000} 
